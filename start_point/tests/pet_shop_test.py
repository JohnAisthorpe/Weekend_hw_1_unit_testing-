...
class TestPetShop(unittest.TestCase):
    ...
    #18 @unittest.skip("delete this line to run the test")
    ...
    #
    #21 @unittest.skip("delete this line to run the test")
    ...
    #22 @unittest.skip("delete this line to run the test")
    ...
    #23 @unittest.skip("delete this line to run the test")
